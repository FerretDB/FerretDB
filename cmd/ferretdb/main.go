...
var (
	...
	versionF         = flag.Bool("version", false, "print version to stdout (full version, commit, dirty flag) and exit")
...
func main() {
	...
	logger.Info(
		...
		zap.String("version", info.Version), zap.String("commit", info.Commit), zap.Bool("dirty", info.Dirty),
	)
