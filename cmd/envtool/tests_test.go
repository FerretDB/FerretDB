...
func TestRunGoTest(t *testing.T) {
	...
	t.Run("Error", func(t *testing.T) {
		...
		expected := []string{
			...
			"ERROR	FAIL TestError1 1/2:",
			"ERROR	=== RUN   TestError1",
			"ERROR	    error_test.go:20: not hidden 1",
			"ERROR	    error_test.go:22: Error 1",
			"ERROR	    error_test.go:24: not hidden 2",
			"ERROR	--- FAIL: TestError1 (<SEC>s)",
			"ERROR	",
			"ERROR	FAIL TestError2/Parallel:",
			"ERROR	=== RUN   TestError2/Parallel",
			"ERROR	    error_test.go:35: not hidden 5",
			"ERROR	=== PAUSE TestError2/Parallel",
			"ERROR	=== CONT  TestError2/Parallel",
			"ERROR	    error_test.go:39: not hidden 6",
			"ERROR	    error_test.go:41: Error 2",
			"ERROR	    error_test.go:43: not hidden 7",
			"ERROR	--- FAIL: TestError2/Parallel (<SEC>s)",
			"ERROR	",
			"ERROR	FAIL TestError2 2/2:",
			"ERROR	=== RUN   TestError2",
			"ERROR	    error_test.go:28: not hidden 3",
			"ERROR	=== PAUSE TestError2",
			"ERROR	=== CONT  TestError2",
			"ERROR	    error_test.go:32: not hidden 4",
