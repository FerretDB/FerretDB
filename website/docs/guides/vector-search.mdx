...
import IndexSyntax from '!!raw-loader!./requests/index-syntax/index-syntax.js';
import SearchSyntax from '!!raw-loader!./requests/search-syntax/search-syntax.js';
import MyDataSet from '!!raw-loader!./requests/vector-search/insert-vector.js';
import HNSWIndex from '!!raw-loader!./requests/vector-search/hnsw-index.js';
import HSNWSearch from '!!raw-loader!./requests/vector-search/hnsw-search.js';
import HNSWSearchResponse from '!!raw-loader!./responses/vector-search/hnsw-search.js';
import IVFIndex from '!!raw-loader!./requests/vector-search/ivf-index.js';
import IVFSearch from '!!raw-loader!./requests/vector-search/ivf-search.js';
import IVFSearchResponse from '!!raw-loader!./responses/vector-search/ivf-search.js';
