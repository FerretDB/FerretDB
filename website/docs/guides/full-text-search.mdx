...
import MyDataSet from '!!raw-loader!./requests/full-text-search/1-insert-text-data.js';
import CreateIndex from '!!raw-loader!./requests/full-text-search/2-create-text-index.js';
import SearchQuery from '!!raw-loader!./requests/full-text-search/3-basic-text-search.js';
import CompoundIndex from '!!raw-loader!./requests/full-text-search/4-compound-text-index.js';
import RelevanceScore from '!!raw-loader!./requests/full-text-search/5-relevance-score.js';
import TextSearchResponse from '!!raw-loader!./responses/full-text-search/3-basic-text-search.js';
import RelevanceScoreResponse from '!!raw-loader!./responses/full-text-search/5-relevance-score.js';
