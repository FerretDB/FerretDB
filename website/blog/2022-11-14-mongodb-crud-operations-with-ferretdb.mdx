...
<script id="insert-1.js" type="text/plain">
  {`
    db.league.insertMany([
    {
        club: "Arsenal",
...
<script id="update-1.js" type="text/plain">
  {`
db.league.insertOne({
    club: "PSG",
    points: 30,
...
<script id="update-2.js" type="text/plain">
  {`
db.league.insertOne({
    club: "PSG",
    points: 30,
...
<script id="delete-1.js" type="text/plain">
  {`
db.league.insertOne({
    club: "PSG",
    points: 30,
...
<script id="delete-2.js" type="text/plain">
  {`
db.league.insertOne({
    club: "PSG",
    points: 30,
