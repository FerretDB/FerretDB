...
import insertData from '!!raw-loader!./full-text-search/1-insert-data.request.js';
import CreateTextIndexRequest from '!!raw-loader!./full-text-search/2-create-text-index.request.js';
import BasicTextSearchRequest from '!!raw-loader!./full-text-search/3-basic-text-search.request.js';
import BasicTextSearchResponse from '!!raw-loader!./full-text-search/3-basic-text-search.response.js';
import DropTextIndexRequest from '!!raw-loader!./full-text-search/4-drop-text-index.request.js';
import CompoundTextIndexRequest from '!!raw-loader!./full-text-search/5-compound-text-index.request.js';
import RelevanceScoreRequest from '!!raw-loader!./full-text-search/6-relevance-score.request.js';
import RelevanceScoreResponse from '!!raw-loader!./full-text-search/6-relevance-score.response.js';
