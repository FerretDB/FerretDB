...
* Connect to it using MongoDB Shell by running `mongosh mongodb://username:password@127.0.0.1:27017/?authMechanism=PLAIN`.
  If you don't have it installed locally, you can use `docker exec -it ferretdb mongosh`.
