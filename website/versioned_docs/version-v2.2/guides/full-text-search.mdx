...
import CreateTextIndexRequest from '!!raw-loader!./full-text-search/1-create-text-index.request.js';
import BasicTextSearchRequest from '!!raw-loader!./full-text-search/2-basic-text-search.request.js';
import BasicTextSearchResponse from '!!raw-loader!./full-text-search/2-basic-text-search.response.js';
import DropTextIndexRequest from '!!raw-loader!./full-text-search/3-drop-text-index.request.js';
import CompoundTextIndexRequest from '!!raw-loader!./full-text-search/4-compound-text-index.request.js';
import RelevanceScoreRequest from '!!raw-loader!./full-text-search/5-relevance-score.request.js';
...
Insert the sample dataset, by downloading the [books.js](./fixtures/books.js). Once downloaded, you can use `mongosh` to insert the documents into your database by running the following command:
