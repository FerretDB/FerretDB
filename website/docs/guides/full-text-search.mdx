...
import MyDataSet from '!!raw-loader!./requests/text-search/insert-text-data.js';
import CreateIndex from '!!raw-loader!./requests/text-search/create-text-index.js';
import SearchQuery from '!!raw-loader!./requests/text-search/basic-text-search.js';
import CompoundIndex from '!!raw-loader!./requests/text-search/compound-text-index.js';
import RelevanceScore from '!!raw-loader!./requests/text-search/relevance-score.js';
import TextSearchResponse from '!!raw-loader!./responses/text-search/basic-text-search.js';
import RelevanceScoreResponse from '!!raw-loader!./responses/text-search/relevance-score.js';
