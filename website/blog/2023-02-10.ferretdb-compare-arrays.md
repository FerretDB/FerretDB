...
[array with non-array BSON type](#comparing-array-and-other-bson-type).
There is uncertainty on how filter such as `$gt` works on [nested array](#filter-operator-with-nested-array)
comparison.
