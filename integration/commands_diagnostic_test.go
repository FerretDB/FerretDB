...
func TestCommandsDiagnosticExplain(t *testing.T) {
	setup.SkipForTigrisWithReason(t, "queryPlanner object is different in Tigris")
...
func TestCommandsDiagnosticExplainTigris(t *testing.T) {
	setup.SkipForPostgresWithReason(t, "queryPlanner object is different in Postgres")
