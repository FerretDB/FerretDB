...
import CreateUniqueIndex from '!!raw-loader!../../guides/requests/create-indexes/1-create-unique-index.js';
import CreateCompoundIndex from '!!raw-loader!../../guides/requests/create-indexes/2-create-compound-index.js';
import CreatePartialIndex from '!!raw-loader!../../guides/requests/create-indexes/3-create-partial-index.js';
...
This compound index can improve performance when filtering or sorting books by their publication date and average rating — for example, fetching recent highly rated books.
