...
### Implicit Operator Comparison
```js
db.implicitexample.insertMany([
  { _id: 'scalar-null', v: null },
  { _id: 'scalar-int', v: 1 },
  { _id: 'scalar-long', v: Long("1") },
  { _id: 'scalar-double', v: 1.0 },
  { _id: 'scalar-decimal', v: Decimal128("1.0") },
  { _id: 'array-empty', v: [] },
  { _id: 'array-int', v: [ 0, 1 ] },
  { _id: 'array-long', v: [ Long("0"), Long("1") ] },
  { _id: 'array-double', v: [ 1.0 ] },
  { _id: 'array-decimal', v: [ Decimal128("0.0"), Decimal128("1.0") ] },
  { _id: 'nested-empty', v: [ [] ] },
  { _id: 'nested-int', v: [ [ 0, 1 ] ] },
  { _id: 'nested-long', v: [ [ Long("0") ], [ Long("1") ] ] },
  { _id: 'nested-double', v: [ [ 1.0 ] ] },
  { _id: 'nested-decimal', v: [ [ Decimal128("1.0"), Decimal128("0.0") ] ] }
])
```

#### Implicit Operator with Scalar Argument

```js
db.implicitexample.find({v: 1})
[
  { _id: 'scalar-int', v: 1 },
  { _id: 'scalar-long', v: Long("1") },
  ...
  { _id: 'array-int', v: [ 0, 1 ] },
  { _id: 'array-long', v: [ Long("0"), Long("1") ] },
  { _id: 'array-double', v: [ 1 ] },
  { _id: 'array-decimal', v: [ Decimal128("0.0"), Decimal128("1.0") ] }
]
```

```js
db.implicitexample.find({v: Decimal128("1.0")})
[
  { _id: 'scalar-int', v: 1 },
  { _id: 'scalar-long', v: Long("1") },
  { _id: 'scalar-double', v: 1 },
...
#### Implicit Operator with Array Argument
...
```js
db.implicitexample.find({v: {$eq: 1}})
[
  { _id: 'scalar-int', v: 1 },
  { _id: 'scalar-long', v: Long("1") },
  { _id: 'scalar-double', v: 1 },
...
```js
db.implicitexample.find({v: {$eq: Decimal128("1.0")}})
[
  { _id: 'scalar-int', v: 1 },
  { _id: 'scalar-long', v: Long("1") },
  { _id: 'scalar-double', v: 1 },
...
is array, it uses array argument to compare with scalar value using BSON comparison order.
