...
import CreateIndex from '!!raw-loader!../../guides/requests/create-indexes/1-create-simple-index.js';
import CreateUniqueIndex from '!!raw-loader!../../guides/requests/create-indexes/2-create-unique-index.js';
import CreateCompoundIndex from '!!raw-loader!../../guides/requests/create-indexes/3-create-compound-index.js';
import CreatePartialIndex from '!!raw-loader!../../guides/requests/create-indexes/4-create-partial-index.js';
...
db.runCommand({
  ...
  indexes: [
    {
      key: { "<field>": <int32 or string>,
        ...
        // Additional fields can go here
       },
      name: "<string>",
      unique: <boolean>, // Optional for unique indexes
      partialFilterExpression: <document>, // Optional for partial indexes
      expireAfterSeconds: <int32> // Optional for TTL indexes
      sparse: <boolean> // Optional for sparse indexes
      cosmosSearchOptions: <document> // Optional for vector indexes
    },
    ...,
    // Additional index specification documents can go here
  ]
})
```
...
Please find other advanced index creation examples below:
