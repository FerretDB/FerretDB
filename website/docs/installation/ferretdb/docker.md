...
[`ghcr.io/ferretdb/ferretdb:2.4.0`](https://ghcr.io/ferretdb/ferretdb:2.4.0)
...
:::tip
We strongly recommend specifying the full image tag (e.g., `2.4.0`)
...
Once DocumentDB is updated, edit your Docker compose file to point to the latest FerretDB production image tag as shown in the FerretDB release notes, for example `2.4.0`, then run:
