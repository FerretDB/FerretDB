...
As we previously mentioned in the last release, FerretDB will no longer support the [Tigris backend](https://www.tigrisdata.com/) If you wish to continue using Tigris, please do not update FerretDB beyond v1.50.
