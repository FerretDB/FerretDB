...
`$max` update operator updates the records that satisfy the comparison condition.
...
update operator to update the collections at once.
...
Only `number` was updated, because string BSON comparison
