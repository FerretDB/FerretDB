...
import CreateIndex from '!!raw-loader!./requests/1-create-ttl-index/create-ttl-index.js';
import InsertTTLData from '!!raw-loader!./requests/2-insert-ttl-data/insert-ttl-data.js';
