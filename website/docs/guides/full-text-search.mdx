...
import MyDataSet from '!!raw-loader!./requests/1-insert-text-data/insert-text-data.js';
import CreateIndex from '!!raw-loader!./requests/2-create-text-index/create-text-index.js';
import SearchQuery from '!!raw-loader!./requests/3-basic-text-search/basic-text-search.js';
import CompoundIndex from '!!raw-loader!./requests/4-compound-text-index/compound-text-index.js';
import RelevanceScore from '!!raw-loader!./requests/5-relevance-score/relevance-score.js';
import TextSearchResponse from '!!raw-loader!./responses/3-basic-text-search/basic-text-search.js';
import RelevanceScoreResponse from '!!raw-loader!./responses/5-relevance-score/relevance-score.js';
