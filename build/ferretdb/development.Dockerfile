...
FROM --platform=$BUILDPLATFORM golang:1.25.2-bookworm AS development-prepare
...
# TODO https://github.com/FerretDB/FerretDB/issues/5449
FROM golang:1.25.2-bookworm AS development-build
...
# TODO https://github.com/FerretDB/FerretDB/issues/5449
FROM golang:1.25.2-bookworm AS development
