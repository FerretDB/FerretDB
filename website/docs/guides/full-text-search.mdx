...
import CreateIndex from '!!raw-loader!./full-text-search/1-create-text-index.request.js';
import SearchQuery from '!!raw-loader!./full-text-search/2-basic-text-search.request.js';
import DropTextIndex from '!!raw-loader!./full-text-search/3-drop-text-index.request.js';
import CompoundIndex from '!!raw-loader!./full-text-search/4-compound-text-index.request.js';
import RelevanceScore from '!!raw-loader!./full-text-search/5-relevance-score.request.js';
import TextSearchResponse from '!!raw-loader!./full-text-search/2-basic-text-search.response.js';
import RelevanceScoreResponse from '!!raw-loader!./full-text-search/5-relevance-score.response.js';
...
Insert the following documents into the `books` collection by downloading the `books.js` from [books.js](./fixtures/books.js). Once downloaded, you can use `mongosh` to insert the documents into your database by running the following command:

```bash
mongosh --file books.js
```
...
<CodeBlock language="js">{DropTextIndex}</CodeBlock>
