db.books.insertMany([
  {
    ...
    summary:
      'This novel portrays the life and challenges of Elizabeth Bennet as she navigates ' +
      'societal expectations, class prejudice, and romance. The book explores the evolving ' +
      'relationship between Elizabeth and Mr. Darcy, shedding light on the virtues of understanding ' +
      'and self-awareness.',
    vector: [
  ...
  },
  {
    ...
    summary:
      'Victor Frankenstein creates life through unorthodox scientific methods but is horrified ' +
      'by his creation. As his creature seeks acceptance, the novel explores themes of ' +
      'responsibility, alienation, and the ethical limits of scientific experimentation.',
    vector: [
  ...
  },
  {
    ...
    textual_analysis: {
      description:
        'An extensive guide covering database design, use, and implementation, suitable for ' +
    ...
    summary:
      'This book offers a comprehensive exploration of database systems, focusing on both ' +
      'theoretical foundations and practical implementation aspects. It covers topics such ' +
      'as SQL standards, data storage, query processing, and transaction management, making ' +
      'it a valuable resource for understanding the complexities of database management ' +
      'systems.'
  },
  {
    _id: 'clean_code_2008',
    ...
    textual_analysis: {
      description:
        'A comprehensive guide focusing on writing clean, readable, and maintainable code, ' +
        'emphasizing the principles of agile software craftsmanship.',
    ...
    summary:
      'This book delves into the principles and practices of writing clean code. It offers ' +
      'insights into code readability, maintainability, and the importance of adhering ' +
      'to best practices in software development. Through real-world examples, it illustrates ' +
      'common pitfalls and how to avoid them, making it a valuable resource for both novice ' +
