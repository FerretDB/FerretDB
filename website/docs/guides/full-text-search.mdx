...
import MyDataSet from '!!raw-loader!./code/requests/full-text-search/1-insert-text-data.js';
import CreateIndex from '!!raw-loader!./code/requests/full-text-search/2-create-text-index.js';
import SearchQuery from '!!raw-loader!./code/requests/full-text-search/3-basic-text-search.js';
import CompoundIndex from '!!raw-loader!./code/requests/full-text-search/4-compound-text-index.js';
import RelevanceScore from '!!raw-loader!./code/requests/full-text-search/5-relevance-score.js';
import TextSearchResponse from '!!raw-loader!./code/responses/full-text-search/3-basic-text-search.js';
import RelevanceScoreResponse from '!!raw-loader!./code/responses/full-text-search/5-relevance-score.js';
