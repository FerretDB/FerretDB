...
import CreateIndex from '!!raw-loader!./code/requests/ttl-indexes/1-create-ttl-index.js';
import InsertTTLData from '!!raw-loader!./code/requests/ttl-indexes/2-insert-ttl-data.js';
