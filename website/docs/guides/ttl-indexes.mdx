...
import CreateIndex from '!!raw-loader!./ttl-indexes/1-create-ttl-index.request.js';
import InsertTTLData from '!!raw-loader!./ttl-indexes/2-insert-ttl-data.request.js';
