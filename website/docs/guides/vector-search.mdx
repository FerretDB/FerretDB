...
import IndexSyntax from '!!raw-loader!./requests/vector-search/2-hnsw-index.js';
import SearchSyntax from '!!raw-loader!./requests/vector-search/5-ivf-search.js';
import MyDataSet from '!!raw-loader!./requests/vector-search/1-insert-vector.js';
import HNSWIndex from '!!raw-loader!./requests/vector-search/2-hnsw-index.js';
import HSNWSearch from '!!raw-loader!./requests/vector-search/3-hnsw-search.js';
import HNSWSearchResponse from '!!raw-loader!./responses/vector-search/3-hnsw-search.js';
import IVFIndex from '!!raw-loader!./requests/vector-search/4-ivf-index.js';
import IVFSearch from '!!raw-loader!./requests/vector-search/5-ivf-search.js';
import IVFSearchResponse from '!!raw-loader!./responses/vector-search/5-ivf-search.js';
