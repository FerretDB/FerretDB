...
func TestOpQuery(t *testing.T) {
	...
	t.Run("CollectionNameWithout.$cmd", func(t *testing.T) {
		...
		expectedMsg := "OP_QUERY is no longer supported. The client driver may require an update."
	...
	t.Run("UnknownOpQuery", func(t *testing.T) {
		...
		expectedMsg := "Unsupported OP_QUERY command: unknown. The client driver may require an update."
