		...
		t.Run(name, func(t *testing.T) {
			...
			for i := range targetCollections {
				...
				t.Run(targetCollection.Name(), func(t *testing.T) {
					...
					allDocs := integration.FindAll(t, ctx, targetCollection)
					...
					for _, doc := range allDocs {
						...
						t.Run(fmt.Sprint(id), func(t *testing.T) {
							...
							if targetErr != nil {
								...
								if errors.As(targetErr, &e) && e.HasErrorCode(integration.DocumentValidationFailureCode) {
							...
							integration.AssertEqualDocuments(t, compatFindRes, targetFindRes)
						})
					}
				})
			}
				...
				t.Run(targetCollection.Name(), func(t *testing.T) {
					...
					for _, doc := range allDocs {
						...
						t.Run(fmt.Sprint(id), func(t *testing.T) {
							...
							targetDoc := integration.ConvertDocument(t, targetFindRes)
							compatDoc := integration.ConvertDocument(t, compatFindRes)
