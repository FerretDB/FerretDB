...
func BsonAggregationCount(ctx context.Context, db DB, l *slog.Logger, databasename string, countSpec wirebson.RawDocument) (outDocument wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT document::bytea FROM documentdb_api_catalog.bson_aggregation_count($1, $2::bytea)", databasename, countSpec)
...
func BsonAggregationDistinct(ctx context.Context, db DB, l *slog.Logger, databasename string, distinctSpec wirebson.RawDocument) (outDocument wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT document::bytea FROM documentdb_api_catalog.bson_aggregation_distinct($1, $2::bytea)", databasename, distinctSpec)
	if err = row.Scan(&outDocument); err != nil {
...
func BsonAggregationFind(ctx context.Context, db DB, l *slog.Logger, databasename string, findSpec wirebson.RawDocument) (outDocument wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT document::bytea FROM documentdb_api_catalog.bson_aggregation_find($1, $2::bytea)", databasename, findSpec)
	if err = row.Scan(&outDocument); err != nil {
...
func BsonAggregationPipeline(ctx context.Context, db DB, l *slog.Logger, databasename string, aggregationpipeline wirebson.RawDocument) (outDocument wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT document::bytea FROM documentdb_api_catalog.bson_aggregation_pipeline($1, $2::bytea)", databasename, aggregationpipeline)
	if err = row.Scan(&outDocument); err != nil {
...
func BsonArrayAgg(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 string) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_array_agg", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_array_agg($1::bytea, $2)", anonymous, anonymous1)
...
func BsonArrayAgg1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 string, anonymous12 bool) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_array_agg", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_array_agg($1::bytea, $2, $3)", anonymous, anonymous1, anonymous12)
	if err = row.Scan(); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_array_agg", l)
	}
	return
...
func BsonArrayAggFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonArrayAggFinal wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_array_agg_final::bytea FROM documentdb_api_catalog.bson_array_agg_final($1)", anonymous)
...
func BsonArrayAggTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 string) (outBsonArrayAggTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_array_agg_transition FROM documentdb_api_catalog.bson_array_agg_transition($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonArrayAggTransition1(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 string, anonymous123 bool) (outBsonArrayAggTransition struct{}, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_array_agg_transition", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_array_agg_transition FROM documentdb_api_catalog.bson_array_agg_transition($1, $2::bytea, $3, $4)", anonymous, anonymous1, anonymous12, anonymous123)
	if err = row.Scan(&outBsonArrayAggTransition); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_array_agg_transition", l)
	}
	return
...
func BsonAvgFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonAvgFinal wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_avg_final", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_avg_final::bytea FROM documentdb_api_catalog.bson_avg_final($1)", anonymous)
...
func BsonBuildDistinctResponse(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonBuildDistinctResponse wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_build_distinct_response::bytea FROM documentdb_api_catalog.bson_build_distinct_response($1)", anonymous)
...
func BsonDistinctAgg(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_distinct_agg", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_distinct_agg($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func BsonDistinctUnwind(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 string) (outBsonDistinctUnwind wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_distinct_unwind::bytea FROM documentdb_api_catalog.bson_distinct_unwind($1::bytea, $2)", anonymous, anonymous1)
...
func BsonDollarAddFields(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument) (outBsonDollarAddFields wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_add_fields::bytea FROM documentdb_api_catalog.bson_dollar_add_fields($1::bytea, $2::bytea)", document, pathSpec)
...
func BsonDollarAll(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarAll bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_all", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_all FROM documentdb_api_catalog.bson_dollar_all($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarBitsAllClear(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarBitsAllClear bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_bits_all_clear FROM documentdb_api_catalog.bson_dollar_bits_all_clear($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarBitsAllSet(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarBitsAllSet bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_bits_all_set FROM documentdb_api_catalog.bson_dollar_bits_all_set($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarBitsAnyClear(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarBitsAnyClear bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_bits_any_clear FROM documentdb_api_catalog.bson_dollar_bits_any_clear($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarBitsAnySet(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarBitsAnySet bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_bits_any_set FROM documentdb_api_catalog.bson_dollar_bits_any_set($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarElemmatch(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarElemmatch bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_elemmatch FROM documentdb_api_catalog.bson_dollar_elemmatch($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarEq(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarEq bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_eq", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_eq FROM documentdb_api_catalog.bson_dollar_eq($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarEq1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outBsonDollarEq bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_eq", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_eq FROM documentdb_api_catalog.bson_dollar_eq($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarEq); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_eq", l)
	}
	return
...
func BsonDollarExists(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarExists bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_exists", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_exists FROM documentdb_api_catalog.bson_dollar_exists($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarExpr(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarExpr bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_expr", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_expr FROM documentdb_api_catalog.bson_dollar_expr($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarFacetProject(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 bool) (outBsonDollarFacetProject wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_facet_project::bytea FROM documentdb_api_catalog.bson_dollar_facet_project($1::bytea, $2)", anonymous, anonymous1)
...
func BsonDollarGeointersects(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarGeointersects bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_geointersects FROM documentdb_api_catalog.bson_dollar_geointersects($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarGeowithin(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarGeowithin bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_geowithin FROM documentdb_api_catalog.bson_dollar_geowithin($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarGt(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarGt bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_gt", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_gt FROM documentdb_api_catalog.bson_dollar_gt($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarGt1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outBsonDollarGt bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_gt", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_gt FROM documentdb_api_catalog.bson_dollar_gt($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarGt); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_gt", l)
	}
	return
...
func BsonDollarGte(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarGte bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_gte", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_gte FROM documentdb_api_catalog.bson_dollar_gte($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarGte1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outBsonDollarGte bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_gte", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_gte FROM documentdb_api_catalog.bson_dollar_gte($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarGte); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_gte", l)
	}
	return
...
func BsonDollarIn(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarIn bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_in", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_in FROM documentdb_api_catalog.bson_dollar_in($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarJsonSchema(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarJsonSchema bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_json_schema FROM documentdb_api_catalog.bson_dollar_json_schema($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarLt(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarLt bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_lt", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_lt FROM documentdb_api_catalog.bson_dollar_lt($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarLt1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outBsonDollarLt bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_lt", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_lt FROM documentdb_api_catalog.bson_dollar_lt($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarLt); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_lt", l)
	}
	return
...
func BsonDollarLte(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarLte bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_lte", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_lte FROM documentdb_api_catalog.bson_dollar_lte($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarLte1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outBsonDollarLte bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_lte", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_lte FROM documentdb_api_catalog.bson_dollar_lte($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarLte); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_lte", l)
	}
	return
...
func BsonDollarMod(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarMod bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_mod", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_mod FROM documentdb_api_catalog.bson_dollar_mod($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarNe(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarNe bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_ne", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_ne FROM documentdb_api_catalog.bson_dollar_ne($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarNin(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarNin bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_nin", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_nin FROM documentdb_api_catalog.bson_dollar_nin($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarProject(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument) (outBsonDollarProject wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_project::bytea FROM documentdb_api_catalog.bson_dollar_project($1::bytea, $2::bytea)", document, pathSpec)
...
func BsonDollarProjectFind(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument, querySpec wirebson.RawDocument) (outBsonDollarProjectFind wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_project_find::bytea FROM documentdb_api_catalog.bson_dollar_project_find($1::bytea, $2::bytea, $3::bytea)", document, pathSpec, querySpec)
...
func BsonDollarProjectGeonear(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarProjectGeonear wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_project_geonear::bytea FROM documentdb_api_catalog.bson_dollar_project_geonear($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarRegex(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarRegex bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_regex", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_regex FROM documentdb_api_catalog.bson_dollar_regex($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarReplaceRoot(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument) (outBsonDollarReplaceRoot wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_dollar_replace_root::bytea FROM documentdb_api_catalog.bson_dollar_replace_root($1::bytea, $2::bytea)", document, pathSpec)
...
func BsonDollarSet(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument) (outBsonDollarSet wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_set", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_set::bytea FROM documentdb_api_catalog.bson_dollar_set($1::bytea, $2::bytea)", document, pathSpec)
...
func BsonDollarSize(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarSize bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_size", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_size FROM documentdb_api_catalog.bson_dollar_size($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarType(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarType bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_type", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_type FROM documentdb_api_catalog.bson_dollar_type($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonDollarUnset(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, pathSpec wirebson.RawDocument) (outBsonDollarUnset wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_unset", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_unset::bytea FROM documentdb_api_catalog.bson_dollar_unset($1::bytea, $2::bytea)", document, pathSpec)
...
func BsonDollarUnwind(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 string) (outBsonDollarUnwind wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_unwind", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_unwind::bytea FROM documentdb_api_catalog.bson_dollar_unwind($1::bytea, $2)", anonymous, anonymous1)
...
func BsonDollarUnwind1(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonDollarUnwind wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_dollar_unwind", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_dollar_unwind::bytea FROM documentdb_api_catalog.bson_dollar_unwind($1::bytea, $2::bytea)", anonymous, anonymous1)
	if err = row.Scan(&outBsonDollarUnwind); err != nil {
		err = mongoerrors.Make(ctx, err, "documentdb_api_catalog.bson_dollar_unwind", l)
	}
	return
...
func BsonExpressionGet(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, expressionSpec wirebson.RawDocument, isnullonempty bool) (outBsonExpressionGet wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_expression_get::bytea FROM documentdb_api_catalog.bson_expression_get($1::bytea, $2::bytea, $3)", document, expressionSpec, isnullonempty)
...
func BsonExpressionMap(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, sourcearrayname string, expressionSpec wirebson.RawDocument, isnullonempty bool) (outBsonExpressionMap wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_expression_map::bytea FROM documentdb_api_catalog.bson_expression_map($1::bytea, $2, $3::bytea, $4)", document, sourcearrayname, expressionSpec, isnullonempty)
...
func BsonFirstCombine(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outBsonFirstCombine struct{}, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_first_combine", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_first_combine FROM documentdb_api_catalog.bson_first_combine($1, $2)", anonymous, anonymous1)
...
func BsonFirstLastFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonFirstLastFinal wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_first_last_final::bytea FROM documentdb_api_catalog.bson_first_last_final($1)", anonymous)
...
func BsonFirstLastFinalOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonFirstLastFinalOnSorted wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_first_last_final_on_sorted::bytea FROM documentdb_api_catalog.bson_first_last_final_on_sorted($1)", anonymous)
...
func BsonFirstTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 struct{}) (outBsonFirstTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_first_transition FROM documentdb_api_catalog.bson_first_transition($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonFirstTransitionOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument) (outBsonFirstTransitionOnSorted struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_first_transition_on_sorted FROM documentdb_api_catalog.bson_first_transition_on_sorted($1, $2::bytea)", anonymous, anonymous1)
...
func BsonFirstnCombine(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outBsonFirstnCombine struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_firstn_combine FROM documentdb_api_catalog.bson_firstn_combine($1, $2)", anonymous, anonymous1)
...
func BsonFirstnLastnFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonFirstnLastnFinal wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_firstn_lastn_final::bytea FROM documentdb_api_catalog.bson_firstn_lastn_final($1)", anonymous)
...
func BsonFirstnLastnFinalOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonFirstnLastnFinalOnSorted wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_firstn_lastn_final_on_sorted::bytea FROM documentdb_api_catalog.bson_firstn_lastn_final_on_sorted($1)", anonymous)
...
func BsonFirstnTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int64, anonymous123 struct{}) (outBsonFirstnTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_firstn_transition FROM documentdb_api_catalog.bson_firstn_transition($1, $2::bytea, $3, $4)", anonymous, anonymous1, anonymous12, anonymous123)
...
func BsonFirstnTransitionOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int64) (outBsonFirstnTransitionOnSorted struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_firstn_transition_on_sorted FROM documentdb_api_catalog.bson_firstn_transition_on_sorted($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonGeonearDistance(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonGeonearDistance float64, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_geonear_distance FROM documentdb_api_catalog.bson_geonear_distance($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonGistGeographyCompress(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonGistGeographyCompress struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geography_compress FROM documentdb_api_catalog.bson_gist_geography_compress($1)", anonymous)
...
func BsonGistGeographyConsistent(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int32) (outBsonGistGeographyConsistent bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geography_consistent FROM documentdb_api_catalog.bson_gist_geography_consistent($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonGistGeographyDistance(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int32) (outBsonGistGeographyDistance float64, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geography_distance FROM documentdb_api_catalog.bson_gist_geography_distance($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonGistGeographyOptions(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_gist_geography_options($1)", anonymous)
	if err = row.Scan(); err != nil {
...
func BsonGistGeometry2dCompress(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonGistGeometry2dCompress struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geometry_2d_compress FROM documentdb_api_catalog.bson_gist_geometry_2d_compress($1)", anonymous)
...
func BsonGistGeometry2dOptions(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_gist_geometry_2d_options($1)", anonymous)
	if err = row.Scan(); err != nil {
...
func BsonGistGeometryConsistent2d(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int32) (outBsonGistGeometryConsistent2d bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geometry_consistent_2d FROM documentdb_api_catalog.bson_gist_geometry_consistent_2d($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonGistGeometryDistance2d(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int32) (outBsonGistGeometryDistance2d float64, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_gist_geometry_distance_2d FROM documentdb_api_catalog.bson_gist_geometry_distance_2d($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonLastCombine(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outBsonLastCombine struct{}, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_last_combine", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_last_combine FROM documentdb_api_catalog.bson_last_combine($1, $2)", anonymous, anonymous1)
...
func BsonLastTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 struct{}) (outBsonLastTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_last_transition FROM documentdb_api_catalog.bson_last_transition($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonLastTransitionOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument) (outBsonLastTransitionOnSorted struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_last_transition_on_sorted FROM documentdb_api_catalog.bson_last_transition_on_sorted($1, $2::bytea)", anonymous, anonymous1)
...
func BsonLastnCombine(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outBsonLastnCombine struct{}, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_lastn_combine", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_lastn_combine FROM documentdb_api_catalog.bson_lastn_combine($1, $2)", anonymous, anonymous1)
...
func BsonLastnTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int64, anonymous123 struct{}) (outBsonLastnTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_lastn_transition FROM documentdb_api_catalog.bson_lastn_transition($1, $2::bytea, $3, $4)", anonymous, anonymous1, anonymous12, anonymous123)
...
func BsonLastnTransitionOnSorted(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int64) (outBsonLastnTransitionOnSorted struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_lastn_transition_on_sorted FROM documentdb_api_catalog.bson_lastn_transition_on_sorted($1, $2::bytea, $3)", anonymous, anonymous1, anonymous12)
...
func BsonLookupUnwind(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 string) (outBsonLookupUnwind wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_lookup_unwind", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_lookup_unwind::bytea FROM documentdb_api_catalog.bson_lookup_unwind($1::bytea, $2)", anonymous, anonymous1)
...
func BsonMaxCombine(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonMaxCombine wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_max_combine", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_max_combine::bytea FROM documentdb_api_catalog.bson_max_combine($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonMaxTransition(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonMaxTransition wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_max_transition::bytea FROM documentdb_api_catalog.bson_max_transition($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonMinCombine(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonMinCombine wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_min_combine", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_min_combine::bytea FROM documentdb_api_catalog.bson_min_combine($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonMinMaxFinal(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (outBsonMinMaxFinal wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_min_max_final", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_min_max_final::bytea FROM documentdb_api_catalog.bson_min_max_final($1::bytea)", anonymous)
...
func BsonMinTransition(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonMinTransition wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_min_transition::bytea FROM documentdb_api_catalog.bson_min_transition($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonObjectAgg(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_object_agg", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bson_object_agg($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func BsonObjectAggFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonObjectAggFinal wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_object_agg_final::bytea FROM documentdb_api_catalog.bson_object_agg_final($1)", anonymous)
...
func BsonObjectAggTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument) (outBsonObjectAggTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_object_agg_transition FROM documentdb_api_catalog.bson_object_agg_transition($1, $2::bytea)", anonymous, anonymous1)
...
func BsonOrderby(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonOrderby wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_orderby", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_orderby::bytea FROM documentdb_api_catalog.bson_orderby($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonQueryMatch(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 wirebson.RawDocument) (outBsonQueryMatch bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_query_match", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_query_match FROM documentdb_api_catalog.bson_query_match($1::bytea, $2::bytea)", anonymous, anonymous1)
...
func BsonSumAvgCombine(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outBsonSumAvgCombine struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_sum_avg_combine FROM documentdb_api_catalog.bson_sum_avg_combine($1, $2)", anonymous, anonymous1)
...
func BsonSumAvgTransition(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument) (outBsonSumAvgTransition struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_sum_avg_transition FROM documentdb_api_catalog.bson_sum_avg_transition($1, $2::bytea)", anonymous, anonymous1)
...
func BsonSumFinal(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outBsonSumFinal wirebson.RawDocument, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_sum_final", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_sum_final::bytea FROM documentdb_api_catalog.bson_sum_final($1)", anonymous)
...
func BsonTrueMatch(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (outBsonTrueMatch bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_true_match", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT bson_true_match FROM documentdb_api_catalog.bson_true_match($1::bytea)", anonymous)
...
func BsonValidateGeography(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, keypath string) (outBsonValidateGeography wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_validate_geography::bytea FROM documentdb_api_catalog.bson_validate_geography($1::bytea, $2)", document, keypath)
...
func BsonValidateGeometry(ctx context.Context, db DB, l *slog.Logger, document wirebson.RawDocument, keypath string) (outBsonValidateGeometry wirebson.RawDocument, err error) {
	...
	row := db.QueryRow(ctx, "SELECT bson_validate_geometry::bytea FROM documentdb_api_catalog.bson_validate_geometry($1::bytea, $2)", document, keypath)
...
func Bsonaverage(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonaverage", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonaverage($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Bsonfirst(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonfirst", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonfirst($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(); err != nil {
...
func Bsonfirstn(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 int64, anonymous12 struct{}) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonfirstn", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonfirstn($1::bytea, $2, $3)", anonymous, anonymous1, anonymous12)
	if err = row.Scan(); err != nil {
...
func Bsonfirstnonsorted(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 int64) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonfirstnonsorted", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonfirstnonsorted($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(); err != nil {
...
func Bsonfirstonsorted(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonfirstonsorted", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonfirstonsorted($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Bsonlast(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonlast", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonlast($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(); err != nil {
...
func Bsonlastn(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 int64, anonymous12 struct{}) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonlastn", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonlastn($1::bytea, $2, $3)", anonymous, anonymous1, anonymous12)
	if err = row.Scan(); err != nil {
...
func Bsonlastnonsorted(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 int64) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonlastnonsorted", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonlastnonsorted($1::bytea, $2)", anonymous, anonymous1)
	if err = row.Scan(); err != nil {
...
func Bsonlastonsorted(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonlastonsorted", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonlastonsorted($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Bsonmax(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonmax", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonmax($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Bsonmin(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonmin", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonmin($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Bsonsum(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument) (err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bsonsum", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.bsonsum($1::bytea)", anonymous)
	if err = row.Scan(); err != nil {
...
func Documentdbrumhandler(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outDocumentdbrumhandler struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT documentdbrumhandler FROM documentdb_api_catalog.documentdbrumhandler($1)", anonymous)
...
func DollarSupport(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outDollarSupport struct{}, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.dollar_support", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT dollar_support FROM documentdb_api_catalog.dollar_support($1)", anonymous)
...
func GinBsonCanPreConsistent(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 wirebson.RawDocument, anonymous12 int32, anonymous123 struct{}, anonymous1234 struct{}, anonymous12345 struct{}) (outGinBsonCanPreConsistent bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_can_pre_consistent FROM documentdb_api_catalog.gin_bson_can_pre_consistent($1, $2::bytea, $3, $4, $5, $6)", anonymous, anonymous1, anonymous12, anonymous123, anonymous1234, anonymous12345)
...
func GinBsonCompare(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}) (outGinBsonCompare bool, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.gin_bson_compare", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()

	row := db.QueryRow(ctx, "SELECT gin_bson_compare FROM documentdb_api_catalog.gin_bson_compare($1, $2)", anonymous, anonymous1)
...
func GinBsonComparePartial(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}, anonymous12 struct{}, anonymous123 struct{}) (outGinBsonComparePartial int32, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_compare_partial FROM documentdb_api_catalog.gin_bson_compare_partial($1, $2, $3, $4)", anonymous, anonymous1, anonymous12, anonymous123)
...
func GinBsonConsistent(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}, anonymous12 struct{}, anonymous123 int32, anonymous1234 struct{}, anonymous12345 struct{}) (outGinBsonConsistent bool, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_consistent FROM documentdb_api_catalog.gin_bson_consistent($1, $2, $3, $4, $5, $6)", anonymous, anonymous1, anonymous12, anonymous123, anonymous1234, anonymous12345)
...
func GinBsonExclusionPreConsistent(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}, anonymous12 struct{}, anonymous123 int32, anonymous1234 struct{}, anonymous12345 struct{}, anonymous123456 struct{}, anonymous1234567 struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.gin_bson_exclusion_pre_consistent($1, $2, $3, $4, $5, $6, $7, $8)", anonymous, anonymous1, anonymous12, anonymous123, anonymous1234, anonymous12345, anonymous123456, anonymous1234567)
	if err = row.Scan(); err != nil {
...
func GinBsonExtractQuery(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}, anonymous12 struct{}, anonymous123 struct{}, anonymous1234 struct{}, anonymous12345 struct{}, anonymous123456 struct{}) (outGinBsonExtractQuery struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_extract_query FROM documentdb_api_catalog.gin_bson_extract_query($1::bytea, $2, $3, $4, $5, $6, $7)", anonymous, anonymous1, anonymous12, anonymous123, anonymous1234, anonymous12345, anonymous123456)
...
func GinBsonPreConsistent(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}, anonymous1 struct{}, anonymous12 wirebson.RawDocument, anonymous123 int32, anonymous1234 struct{}, anonymous12345 struct{}, anonymous123456 struct{}, anonymous1234567 struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.gin_bson_pre_consistent($1, $2, $3::bytea, $4, $5, $6, $7, $8)", anonymous, anonymous1, anonymous12, anonymous123, anonymous1234, anonymous12345, anonymous123456, anonymous1234567)
	if err = row.Scan(); err != nil {
...
func GinBsonSinglePathExtractValue(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outGinBsonSinglePathExtractValue struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_single_path_extract_value FROM documentdb_api_catalog.gin_bson_single_path_extract_value($1::bytea, $2)", anonymous, anonymous1)
...
func GinBsonSinglePathOptions(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.gin_bson_single_path_options($1)", anonymous)
	if err = row.Scan(); err != nil {
...
func GinBsonWildcardProjectExtractValue(ctx context.Context, db DB, l *slog.Logger, anonymous wirebson.RawDocument, anonymous1 struct{}) (outGinBsonWildcardProjectExtractValue struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT gin_bson_wildcard_project_extract_value FROM documentdb_api_catalog.gin_bson_wildcard_project_extract_value($1::bytea, $2)", anonymous, anonymous1)
...
func GinBsonWildcardProjectOptions(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (err error) {
	...
	row := db.QueryRow(ctx, "SELECT FROM documentdb_api_catalog.gin_bson_wildcard_project_options($1)", anonymous)
	if err = row.Scan(); err != nil {
...
func QueryMatchSupport(ctx context.Context, db DB, l *slog.Logger, anonymous struct{}) (outQueryMatchSupport struct{}, err error) {
	...
	row := db.QueryRow(ctx, "SELECT query_match_support FROM documentdb_api_catalog.query_match_support($1)", anonymous)
