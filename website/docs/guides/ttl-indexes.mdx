...
import CreateIndex from '!!raw-loader!./requests/ttl-indexes/1-create-ttl-index.js';
import InsertTTLData from '!!raw-loader!./requests/ttl-indexes/2-insert-ttl-data.js';
