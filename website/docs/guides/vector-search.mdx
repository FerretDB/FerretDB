...
import MyDataSet from '!!raw-loader!./vector-search/1-insert-vector.request.js';
import HNSWIndex from '!!raw-loader!./vector-search/2-hnsw-index.request.js';
import HSNWSearch from '!!raw-loader!./vector-search/3-hnsw-search.request.js';
