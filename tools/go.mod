...
replace github.com/golangci/golangci-lint => github.com/AlekSi/golangci-lint v1.41.1-0.20220110095437-aa0821bad659
...
require (
	...
	gitlab.com/bosi/decorder v0.2.0 // indirect
