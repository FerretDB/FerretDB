...
5. Generate changelog:
   - Run `task changelog MILESTONE_TITLE=vX.Y.Z` (fixme: how to pipe to the changelog file???).
   - In the resulting `CHANGELOG.md` file sort items within sections according to importance if needed.
