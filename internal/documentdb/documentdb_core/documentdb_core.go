...
func BsonOut(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonOut string, err error) {
...
func BsonSend(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonSend []byte, err error) {
...
func BsonToBsonHex(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonToBsonHex string, err error) {
...
func BsonToBytea(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonToBytea []byte, err error) {
...
func BsonToJsonString(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonToJsonString string, err error) {
...
func BsonqueryCompare(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonqueryCompare int32, err error) {
...
func BsonqueryIn(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonqueryIn wirebson.RawDocument, err error) {
...
func BsonqueryOut(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonqueryOut string, err error) {
...
func BsonqueryRecv(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonqueryRecv wirebson.RawDocument, err error) {
...
func BsonquerySend(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonquerySend []byte, err error) {
...
func BsonsequenceOut(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonsequenceOut string, err error) {
...
func BsonsequenceSend(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonsequenceSend []byte, err error) {
...
func BsonsequenceToBytea(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonsequenceToBytea []byte, err error) {
