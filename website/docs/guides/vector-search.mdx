...
import MyDataSet from '!!raw-loader!./requests/1-insert-vector/insert-vector.js';
import HNSWIndex from '!!raw-loader!./requests/2-hnsw-index/hnsw-index.js';
import HSNWSearch from '!!raw-loader!./requests/3-hnsw-search/hnsw-search.js';
import HNSWSearchResponse from '!!raw-loader!./responses/3-hnsw-search/hnsw-search.js';
import IVFIndex from '!!raw-loader!./requests/4-ivf-index/ivf-index.js';
import IVFSearch from '!!raw-loader!./requests/5-ivf-search/ivf-search.js';
import IVFSearchResponse from '!!raw-loader!./responses/5-ivf-search/ivf-search.js';
