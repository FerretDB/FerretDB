...
require (
	...
	golang.org/x/tools v0.1.11-0.20220420201907-5d7ca8a1b5bc // use @master until v0.1.11+ is released for https://github.com/golang/tools/commit/afc6aad76eb1194c038c653531eef344468d2ac4
