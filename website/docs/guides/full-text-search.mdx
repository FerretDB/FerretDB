...
import MyDataSet from '!!raw-loader!./full-text-search/1-insert-text-data.request.js';
import CreateIndex from '!!raw-loader!./full-text-search/2-create-text-index.request.js';
import SearchQuery from '!!raw-loader!./full-text-search/3-basic-text-search.request.js';
...
import TextSearchResponse from '!!raw-loader!./full-text-search/3-basic-text-search.response.js';
