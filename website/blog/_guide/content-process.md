...
The first step to creating a blog post, pitching a draft, or idea is to [create an discussion to suggest/outline the blog post topic here](https://github.com/FerretDB/FerretDB/discussions/new?category=general).
