...
[`ghcr.io/ferretdb/ferretdb:2.3.0`](https://ghcr.io/ferretdb/ferretdb:2.3.0)
...
:::tip
We strongly recommend specifying the full image tag (e.g., `2.3.0`)
...
1. Store the following in the `docker-compose.yml` file:
   ...
   services:
     postgres:
       image: ghcr.io/ferretdb/postgres-documentdb:17-0.104.0-ferretdb-2.3.0
       restart: on-failure
       environment:
     ...
     ferretdb:
       image: ghcr.io/ferretdb/ferretdb:2.3.0
       restart: on-failure
       ports:
         - 27017:27017
       environment:
