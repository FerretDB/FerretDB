...
import InsertData from '!!raw-loader!./vector-search/1-insert-data.request.js';
import HNSWIndexRequest from '!!raw-loader!./vector-search/2-hnsw-index.request.js';
import HNSWSearchRequest from '!!raw-loader!./vector-search/3-hnsw-search.request.js';
import HNSWSearchResponse from '!!raw-loader!./vector-search/3-hnsw-search.response.js';
import IVFIndexRequest from '!!raw-loader!./vector-search/5-ivf-index.request.js';
import IVFSearchRequest from '!!raw-loader!./vector-search/6-ivf-search.request.js';
import IVFSearchResponse from '!!raw-loader!./vector-search/6-ivf-search.response.js';
