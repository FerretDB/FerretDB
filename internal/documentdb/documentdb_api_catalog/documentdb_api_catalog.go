...
func BsonArrayAggTransition(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonArrayAggTransition []byte, err error) {
...
//
//	documentdb_api_catalog.bson_array_agg_transition(OUT bson_array_agg_transition bytea).
func BsonArrayAggTransition1(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonArrayAggTransition []byte, err error) {
	ctx, span := otel.Tracer("").Start(ctx, "documentdb_api_catalog.bson_array_agg_transition", oteltrace.WithSpanKind(oteltrace.SpanKindClient))
	defer span.End()
...
func BsonFirstCombine(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonFirstCombine []byte, err error) {
...
func BsonFirstnCombine(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonFirstnCombine []byte, err error) {
...
func BsonGistGeographyCompress(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonGistGeographyCompress string, err error) {
...
func BsonGistGeographyOptions(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonGistGeographyOptions string, err error) {
...
func BsonGistGeometry2dCompress(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonGistGeometry2dCompress string, err error) {
...
func BsonGistGeometry2dOptions(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonGistGeometry2dOptions string, err error) {
...
func BsonLastCombine(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonLastCombine []byte, err error) {
...
func BsonLastnCombine(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonLastnCombine []byte, err error) {
...
func BsonObjectAggTransition(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonObjectAggTransition []byte, err error) {
...
func BsonOutTransition(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonOutTransition []byte, err error) {
...
func BsonSumAvgCombine(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonSumAvgCombine []byte, err error) {
...
func BsonSumAvgTransition(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outBsonSumAvgTransition []byte, err error) {
...
func Documentdbrumhandler(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outDocumentdbrumhandler string, err error) {
...
func DollarSupport(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outDollarSupport string, err error) {
...
func GinBsonComparePartial(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonComparePartial int32, err error) {
...
func GinBsonExclusionPreConsistent(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonExclusionPreConsistent string, err error) {
...
func GinBsonExtractQuery(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonExtractQuery string, err error) {
...
func GinBsonPreConsistent(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonPreConsistent string, err error) {
...
func GinBsonSinglePathExtractValue(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonSinglePathExtractValue string, err error) {
...
func GinBsonSinglePathOptions(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonSinglePathOptions string, err error) {
...
func GinBsonWildcardProjectExtractValue(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonWildcardProjectExtractValue string, err error) {
...
func GinBsonWildcardProjectOptions(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outGinBsonWildcardProjectOptions string, err error) {
...
func QueryMatchSupport(ctx context.Context, conn *pgx.Conn, l *slog.Logger) (outQueryMatchSupport string, err error) {
