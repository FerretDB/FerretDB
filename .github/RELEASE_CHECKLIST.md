...
1. Check [documentdb_core.control](https://github.com/FerretDB/documentdb/blob/ferretdb/pg_documentdb_core/documentdb_core.control)
   has the `default_version` field set to the new version to release. If not, update it.
2. Check a tag exists for the new version to release. Ensure to sync [FerretDB/documentdb](https://github.com/FerretDB/documentdb)
   fork.
